      ...
      <FooterWrap>
        ...
        <SocialMedia>
          <SocialMediaWrap>
            ...
            <WebsiteRights>Jéssica Dantas © {new Date().getFullYear()} All rights reserved.</WebsiteRights>
            <SocialIcons>
              <SocialIconLink href='/' target='_blank' arial-label='Facebook'>
                <FaFacebook />
              </SocialIconLink>
              <SocialIconLink href='//www.instagram.com/arq.jessicadantas/' target='_blank' arial-label='Instagram'>
                <FaInstagram/>
              </SocialIconLink>
